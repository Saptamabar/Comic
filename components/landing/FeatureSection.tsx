...
export function FeatureSection() {
    ...
    // Variasi rotasi agar tetap estetik khas komik
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
                    {missionData.cards.map((card, index) => (
                        <motion.div
                            ...
                            className={`p-4 border-4 border-black shadow-pop ${rotations[index % rotations.length]} hover:scale-105 transition-transform group`}
                        >
                            <div className="bg-white border-4 border-black p-6 h-full relative overflow-hidden">
                                ...
                                {/* Halftone Overlay kecil di dalam kartu */}
